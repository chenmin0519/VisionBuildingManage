...
(function (factory) {
    ...
    $.fn.fileinputLocales.en = {
        ...
        msgCancelled: '取消',
        msgPlaceholder: '选中 {files}...',
        msgZoomModalHeading: '详细预览',
        msgFileRequired: '你只能上传选中文件',
        msgSizeTooSmall: '文件 "{name}" (<b>{size} KB</b>) 太小，必须大于 <b>{minSize} KB</b>.',
        msgSizeTooLarge: '文件 "{name}" (<b>{size} KB</b>) 超过最大允许上传大小 <b>{maxSize} KB</b>.',
        msgFilesTooLess: '您必须至少选择 <b>{n}</b> {files} 上传.',
        msgFilesTooMany: '上传文件数 <b>({n})</b> 超过最大允许限度 <b>{m}</b>.',
        ...
        msgInvalidFileName: '文件名中无效或不支持的字符 "{name}".',
