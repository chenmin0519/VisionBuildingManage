                                            ...
                                            <div class="panel panel-default">
                                                <form id="form">
                                                    <div class="form-group col-sm-3 col-md-3 col-xs-3 pull-left">
                                                        <input type="text" placeholder="请输入名称" class="form-control" name="business">
                                                    </div>
                                                    <div class="form-group col-sm-3 col-md-3 col-xs-3 pull-left">
                                                        <input type="text" placeholder="请输入编码" class="form-control" name="pinyin">
                                                    </div>
                                                    <div class="form-group col-sm-3 col-md-3 col-xs-3 pull-left">
                                                        <input type="text" placeholder="请输入电话" class="form-control" name="mobile">
                                                    </div>
...
<script type="text/javascript">
    ...
    function initTbale(){
        ...
        initBaseTable($("form").serialize(),"datatable","${base}/data/business/getDates",",pinyin,business,mobile,",functionlist);
    }
    ...
    function del(id){
        baseCallBackAJAX("get","${base}/data/business/del",{'id':id},"json","callback(data)");
    }
    ...
    function detil(id){
        window.location.href="${base}/data/business/edit.html?id="+id+"&chirld=${chirld}&parent=${parent}";
    }
    $("#add").click(function(){
        window.location.href="${base}/data/business/add.html?chirld=${chirld}&parent=${parent}";
    });
</script>
