        ...
        <div class="content-page">
            ...
            <div class="content">
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <h4 class="pull-left page-title">试题管理</h4>
                                            ...
                                            <div class="panel panel-default">
                                                <form id="form">
                                                    <div class="form-group col-sm-3 col-md-3 col-xs-3 pull-left">
                                                        <input type="text" placeholder="请输入问题名称" class="form-control" name="question">
                                                    </div>
                                                    <div class="form-group col-sm-3 col-md-3 col-xs-3 pull-left">
                                                        <label class="form-group col-sm-4 col-md-4 col-xs-4 pull-left " style="line-height: 40px">部门：</label>
                                                        <div class="form-group col-sm-8 col-md-8 col-xs-8 pull-left">
                                                            <select id="departmentId"  name="departmentId" class="form-control valid" >
                                                                <option value=""> --请选择-- </option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="form-group col-sm-3 col-md-3 col-xs-3 pull-left">
                                                        <label class="form-group col-sm-4 col-md-4 col-xs-4 pull-left " style="line-height: 40px">题型：</label>
                                                        <div class="form-group col-sm-8 col-md-8 col-xs-8 pull-left">
...
<%--                                                                <option value="4"> 简答题 </option>--%>
                                                    ...
                                                    <div class="form-group col-sm-1 col-md-1 col-xs-3 pull-left">
                                                        <button id="import" type="button" style="position: absolute;right: -10px;"
                                                                class="btn btn-primary waves-effect waves-light m-b-5">
...
<script type="text/javascript">
    ...
    var functionlist=[{targets:[6],
        ...
        mRender:function(data) {
            var result = "";
            //0.单选题 1.多选选题 2.判断题 3.填空题 4.简答题
            if(data.type == 0){
                result = "单选题";
            }else if(data.type == 1){
                result = "多选选题";
    ...
    function initTbale(){
        ...
        initBaseTable($("form").serialize(),"datatable","${base}/test/question/getDates",",departmentName,question,,answer,,",functionlist);
    }
    ...
    function del(id){
        <%--baseCallBackAJAX("get","${base}/test/question/del",{'id':id},"json","callback(data)");--%>
        baseCallBackAJAX("get","${base}/test/paper/getPay",null,"json","callback(data)");
    }

    function callback(data){
        window.location.href="http://payment.fudan.edu.cn/pay/dealPay.html?pwd="+data.value;
        // if(data.status=="0"){
        //     swal({
        //         title: "操作成功",
        //         text:data.message,
    ...
    function detail(id){
        window.location.href="${base}/test/question/edit.html?id="+id+"&chirld=${chirld}&parent=${parent}";
    }
    $("#add").click(function(){
        window.location.href="${base}/test/question/add.html?chirld=${chirld}&parent=${parent}";
    });
    $("#import").click(function(){
        window.location.href="${base}/test/question/import.html?chirld=${chirld}&parent=${parent}";
    });
</script>
