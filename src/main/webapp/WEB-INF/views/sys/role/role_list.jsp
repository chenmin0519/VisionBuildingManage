                                            ...
                                            <div class="panel panel-default">
                                                <form id="form">
                                                    <div class="form-group col-sm-3 col-md-3 col-xs-3 pull-left">
                                                        <input type="text" placeholder="请输入角色名" class="form-control" name="roleName">
                                                    </div>
...
<script type="text/javascript">
    var functionlist=[{targets:[4],
        mRender:function(data) {
            ...
            if(data.status == 1){
                ...
                /*
                &nbsp;&nbsp;<button type=button style='padding: 1px 8px !important;' class='btn btn-primary waves-effect waves-light m-b-5' onclick=view('"
    ...
    function initTbale(){
        ...
        initBaseTable($("form").serialize(),"datatable","${base}/sys/role/getDates",",roleName,roleComment,,",functionlist);
    }
    ...
    function del(id){
        baseCallBackAJAX("get","${base}/sys/role/delRole",{'id':id},"json","callback(data)");
    }
    function view(id){
        window.location.href="${base}/sys/role/view.html?id="+id+"&chirld=${chirld}&parent=${parent}";
    }
    function detil(id){
        window.location.href="${base}/sys/role/edit.html?id="+id+"&chirld=${chirld}&parent=${parent}";
    }
    $("#add").click(function(){
        window.location.href="${base}/sys/role/addRole.html?chirld=${chirld}&parent=${parent}";
    });
