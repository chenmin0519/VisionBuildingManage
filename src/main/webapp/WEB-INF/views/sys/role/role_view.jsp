                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row">
                                        <div class="panel panel-default">
                                            <form id="form">
                                                <input id="wid" name="wid" type="hidden" value="${po.wid}"/>
                                                ...
                                                <div class="form-group col-sm-12 col-md-12 col-xs-12">
                                                    ...
                                                    <input type="hidden" name="zt" id="zt" value="${po.zt}"/>
                                                    <div class="col-sm-8">
                                                        <p><c:if test="${po.zt == '1'}">正常</c:if><c:if test="${po.zt != '1'}">冻结</c:if></p>
                                                    </div>
                                                </div>
                                                <div class="form-group col-sm-12 col-md-12 col-xs-12">
...
<script type="text/javascript">
    ...
    $("#save").click(function(){
        ...
        var zt = $("#zt").val();
        baseCallBackAJAX("post","${base}/sys/role/saveRole",{"roleName":roleName,"roleComment":roleComment,"zt":zt},"json","saveCallback(data)");
    });
