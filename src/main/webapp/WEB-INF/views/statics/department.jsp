...
<script type="text/javascript">
    ...
    var functionlist = [{targets:[2],
        ...
        mRender:function(data) {
            var result = "";
            result = data.allCost - data.totalCost;
            if(result){
                result = result/100;
            }else{
                result = "";
    ...
    function initTbale(){
        ...
        initBaseTable(par,"datatable","${base}/data/settlement/getdepartmentEchartInfoPage",",departmentName,allCost,totalCost,",functionlist);
    }
    ...
    function initImage(){
        var par = $("form").serialize();
        baseCallBackAJAX("post","${base}/data/settlement/getdepartmentEchartInfo",par,"json","getData(data)");
    }
