                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                                ...
                                                <form id="form">
                                                    <div class="col-sm-2 col-lg-2 col-md-2 pull-left"
                                                        ...
                                                        <div class='input-group date' id='datetimepicker3'>
                                                            <input placeholder="开始日期" type='text' id="startTime"
                                                                   name="startTime" class="form-control" /> <span
                                                                class="input-group-addon"><span
                                                                class="glyphicon glyphicon-calendar"></span> </span>
                                                        </div>
                                                    </div>
                                                    <div class="pull-left" style="line-height: 30px;">至</div>
                                                    <div class="col-sm-2 col-lg-2 col-md-2 pull-left"
                                                         style="min-width: 267px">
                                                        <div class='input-group date' id='datetimepicker4'>
                                                            <input placeholder="结束日期" type='text' id="endTime"
                                                                   name="endTime" class="form-control" /> <span
                                                                class="input-group-addon"><span
                                                                class="glyphicon glyphicon-calendar"></span> </span>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-md-12 col-sm-12 col-xs-12" id = "datatable_div" style="display: none">
                                                <table id="datatable"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th nowrap="nowrap">设计师</th>
                                                        <th nowrap="nowrap">部门成本</th>
                                                        <th nowrap="nowrap">奖金</th>
                                                        <th nowrap="nowrap">罚款</th>
                                                        <th nowrap="nowrap">基本工资</th>
                                                        <th nowrap="nowrap">设计师提成</th>
                                                        <th nowrap="nowrap">应发工资</th>
                                            ...
                                            <div class="col-md-12 col-sm-12 col-xs-12" id="echarts_imge_div">
                                                <div id="huizong" style="padding-top: 10px;padding-left: 60px;">
                                                    <table> <tr><td>总拨款额：</td><td id="sale">0</td><td>总成本：</td><td id="cost">0</td><td>总利润：</td><td id="commission">0</td></tr></table>
                                                </div>
...
<script type="text/javascript">
    ...
    function initTbale(){
        ...
        initBaseTable(par,"datatable","${base}/data/settlement/getUserEchartInfoPage",",designer,totalCost,bonus,fine,wages,designerCommission,payWages,profit",functionlist);
    }
    ...
    function initImage(){
        var par = $("form").serialize();
        baseCallBackAJAX("post","${base}/data/settlement/getUserEchartInfo",par,"json","getData(data)");
    }
